...
6. Now you need to change the first and the second line of the script: in order to do so you should click on the small arrow that you see on the top left of the right panel and then on the number of partecipants (not the icon, the number), right click on the highlighted element in the source tab > copy full xpath > paste it inside the quotes of the first line of the snippet. Then do the same thing again but this time click on the "close call" button and paste the contents of copy full xpath into the quotes of the second line. Press ctrl+S to save the snippet. I Will link here a serie of images to make you see how the selection and pasting process should look like 
7. 
